...
## GBase example
The GBase example provided here shows and example ARP YAML file for GBase and the associated files require to build a connector
from the template. 
...
3. Take the GBase JDBC driver from (http://www.gbase8a.com/forum.php?mod=attachment&aid=NDQxfGQ4MzAyZTllfDE1NzEwNDk0MzB8Mjk2NnwxMzE1&filename=GBase%20JDBC.rar) and put in in the \dremio\jars\3rdparty folder
4. Restart Dremio
